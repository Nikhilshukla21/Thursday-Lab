...
class KidUsers implements LibraryUser // class implementing interface
{
	...
	public void requestbook() {
		...
		if (bookType == "kids") {// checking book type
...
class AdultUser implements LibraryUser // class implementing interface
{
	...
	@Override
	public void requestbook() {
		if (bookType == "Fiction") // checking book type
		{
			System.out.println("Book Issued successfully, please return the book within 10 days!");
		} else {
...
public class LibraryInterfaceDemo {
	...
	public static void main(String[] args) {
		...
		kid.setAge(10); // setting age
		kid.registerAccount(); // invoking
		kid.requestbook();

		System.out.println("=========================================================");

		AdultUser adult = new AdultUser();
		adult.setAge(10); // setting age
		adult.registerAccount();// invoking
		adult.requestbook();
